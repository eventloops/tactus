...
use super::ci_model::{
    ...
    STEP_FIELDS, TEST_COMMAND, TEST_JOB_COMPONENTS, TEST_JOB_FIELDS, TEST_SCRIPTS,
    TEST_WINDOWS_JOB, TEST_WINDOWS_JOB_FIELDS, TEST_WINDOWS_LABELS, TEST_WINDOWS_SCRIPTS,
    TOOLCHAIN_ACTION, TOOLCHAIN_COMPONENTS, WINDOWS_BUILD_WITNESS, WINDOWS_TEST_WITNESS,
...
pub(super) const WORKFLOW_ESCAPES: &[WorkflowEscape] = &[
    ...
    WorkflowEscape {
        ...
        job: Some("test"),
        anchor: "          components: rustfmt, clippy\n",
        replacement: "",
    ...
    WorkflowEscape {
        ...
        job: Some("test"),
        anchor: "          components: rustfmt, clippy\n",
        replacement: "          components: rustfmt, clippy, llvm-tools\n",
        refused_as: "test-job-toolchain",
    },
    WorkflowEscape {
